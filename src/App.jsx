...
const CookiesWebsite = () => {
  ...
  const cookies = [
    ...
    {
      id: 4,
      name: "Classic Chocolate Chips Cookies",
      price: 25,
      image: "🥜",
      description: "Available only during festive season Pre Order.",
      rating: 4.9,
    },
    {
      id: 5,
      name: "Kunafa Brownies",
      price: 100.0,
      image: "⭐",
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-yellow-50 to-yellow-100">
      {/* Header */}
      <header className="bg-yellow-100 shadow-lg sticky top-0 z-50">
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              <img
                src="public/ili.png"
                alt="Ili's Bites Logo"
            ...
            <div className="flex items-center space-x-4">
              ...
              <button
                ...
                onClick={() =>
                  window.open(
                    "https://api.whatsapp.com/send?phone=60193696060&text=Hello%2C%20Can%20I%20place%20an%20order%20%3F%20&fbclid=PAQ0xDSwK_qH9leHRuA2FlbQIxMQABp35McoFcbNjsNWpowHwW53f8K5pLz--pnyHoYSUkpcyq7MiKxO-jLLLzUqJ__aem_WF44fXsXcr4T9Z4VQrGtOQ",
                    "_blank"
                  )
                }
              >
      ...
      {/* Hero Section */}
      <section className="bg-gradient-to-r from-yellow-100 to-yellow-300 text-yellow-900 py-20">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-5xl font-bold mb-6">Freshly Baked Daily</h2>
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            Indulge in our handcrafted cookies made with the finest ingredients
            and baked with love since 1995
          </p>
          ...
          <button
            ...
            className="bg-yellow-700 hover:bg-yellow-800 text-white px-8 py-4 rounded-xl text-lg font-semibold transition-all transform hover:scale-105 shadow-lg"
          >
            View Our Menu
          </button>
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg text-yellow-700 mb-8">
              For over 25 years, we've been crafting the perfect cookies using
              traditional recipes passed down through generations. Every cookie
              is made with premium ingredients, baked fresh daily, and served
              with a smile. Our commitment to quality and customer satisfaction
              has made us the most beloved bakery in town.
            </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-4 mb-8">
                <a
                  href="https://www.instagram.com/theilisbites.kl?igsh=dGpkaDcwc2kyemps"
                  className="flex items-center space-x-3 bg-pink-600 text-white p-4 rounded-lg hover:bg-pink-700 transition-colors"
                >
              ...
              <div className="bg-yellow-100 p-6 rounded-lg">
                ...
                <p className="text-yellow-700 mb-4">
                  ...
                  Plus, be the first to know about new flavors and seasonal
                  specials.
                </p>
